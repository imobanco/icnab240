...
class FileTestCase(TestCase):
    def test__write_cnab(self):
        ...
        with patch('icnab240.controllers.file.open', mocked_file, create=True) as mocked_file:
    ...
    def test_write_cnab(self):
        ...
        with patch('icnab240.controllers.file.build_pieces_of_value_to_cnab', return_value='pieces') as mocked_pieces, \
                patch('icnab240.controllers.file.build_cnab_lines', return_value='lines') as mocked_lines, \
                patch('icnab240.controllers.file._write_cnab') as mocked__write:
